...
namespace BetterAudio
{
    public static partial class BetterAudio
    {
        ...
        public static Behaviour[] playBehaviours = { AutoDestroy, Delay, Fade, Follower, RandomClip, SetSource };
        public static Behaviour[] updateBehaviours = { DestroyAt, FadeAt, Follower, SourceCurves};
        public static Behaviour[] endBehaviours = { AutoDestroy, ClipSerie, Follower,Loop, RandomClip, SetSource };
